...
include struct
  ...
  let _menhir_run_87 : type  ttv_stack. (ttv_stack, _menhir_box_main) _menhir_cell1_list_fonc_ _menhir_cell0_ID -> _ -> _ -> _menhir_box_main =
  ...
  and _menhir_goto_i : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_main) _menhir_state -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | RAT ->
          _menhir_run_01 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState79
      | PRINT ->
          _menhir_run_55 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState79
      | INT ->
          _menhir_run_02 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState79
      | IF ->
          _menhir_run_58 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState79
      | ID _v_0 ->
          _menhir_run_63 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 MenhirState79
      | CONST ->
          _menhir_run_67 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState79
      | BOOL ->
          _menhir_run_03 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState79
      | AF ->
          let _v_1 = _menhir_action_27 () in
          _menhir_run_80 _menhir_stack _menhir_lexbuf _menhir_lexer _v_1
      | _ ->
          _eRR ()
    ...
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _menhir_s ->
      ...
      | ID _v ->
          ...
          | PO ->
              ...
              | ID _v_0 ->
                  _menhir_run_18 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 MenhirState25
              | FALSE ->
                  _menhir_run_19 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState25
              | ENTIER _v_1 ->
                  _menhir_run_20 _menhir_stack _menhir_lexbuf _menhir_lexer _v_1 MenhirState25
              | DENOM ->
              ...
              | PF ->
                  ...
                  _menhir_run_26 _menhir_stack _menhir_lexbuf _menhir_lexer _v_2
              | _ ->
                  _eRR ())
          | _ ->
              _eRR ())
  ...
  and _menhir_run_81 : type  ttv_stack. ((ttv_stack, _menhir_box_main) _menhir_cell1_typ _menhir_cell0_ID, _menhir_box_main) _menhir_cell1_list_param_ -> _ -> _ -> _ -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
      ...
      | INT ->
          _menhir_run_02 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState88
      | BOOL ->
          _menhir_run_03 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState88
      | ID _ ->
          let _v_0 = _menhir_action_25 () in
          _menhir_run_89 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 _tok
      | _ ->
          _eRR ()
  ...
  and _menhir_run_28 : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_main) _menhir_state -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | ID _v_0 ->
          _menhir_run_18 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 MenhirState28
      | FALSE ->
          _menhir_run_19 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState28
      | ENTIER _v_1 ->
          _menhir_run_20 _menhir_stack _menhir_lexbuf _menhir_lexer _v_1 MenhirState28
      | DENOM ->
      ...
      | PF ->
          let _v_2 = _menhir_action_23 () in
          _menhir_run_29 _menhir_stack _menhir_lexbuf _menhir_lexer _v_2
      | _ ->
          _eRR ()
      ...
      | ID _v_0 ->
          ...
          | PO ->
              ...
              | PF ->
                  ...
                  _menhir_run_11 _menhir_stack _menhir_lexbuf _menhir_lexer _v_1 MenhirState06
              | _ ->
                  _eRR ())
          | _ ->
              _eRR ())
