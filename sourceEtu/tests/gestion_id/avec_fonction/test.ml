...
let%test_unit "testFuncBoucle1" =
  let _ = compiler (pathFichiersRat^"testFuncBoucle1.rat") in ()

let%test_unit "testTotal" =
  let _ = compiler (pathFichiersRat^"testTotal.rat") in ()
